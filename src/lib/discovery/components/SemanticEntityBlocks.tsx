...
import { POPULAR_SEARCHES } from "../config/seo";
  ...
  return (
    <aside aria-label="Creator entity details">
      <section>
        <h2>About Creator</h2>
        <p>
          {name} is a {category} creator based in {location}. Brands can review this portfolio to
          understand audience platforms, content niches, collaboration experience and brand fit.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          {name} can be evaluated for campaigns by niche, language, location, platform mix,
          audience size and previous brand collaborations.
        </p>
      </section>
