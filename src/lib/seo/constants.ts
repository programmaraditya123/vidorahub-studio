export const SITE_URL = "https://studio.vidorahub.com";
export const SITE_NAME = "VidoraHub Studio";
...
export const INDEXABLE_PLATFORMS = [
  "instagram",
  "youtube",
  "facebook",
  "linkedin",
...
export const POPULAR_SEARCHES = [
  "fashion creator India",
  "tech influencer Delhi",
  "food creator Mumbai",
  "UGC creator Haryana",
