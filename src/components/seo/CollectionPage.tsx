...
import { INDEXABLE_CATEGORIES, INDEXABLE_CITIES, INDEXABLE_PLATFORMS, INDEXABLE_STATES } from "@/lib/seo/constants";
  ...
  return (
    <main>
      <header>
        ...
        <p>
          Discover {label.toLowerCase()} creator profiles, brand collaboration
          opportunities, social platforms, locations and portfolio signals on
          VidoraHub Studio.
        </p>
      </header>
      ...
      <section>
        ...
        <p>
          VidoraHub Studio structures each public {singular} page as an entity
          with canonical URLs, metadata, JSON-LD, breadcrumbs, social profiles,
          audience details and collaboration context for search engines and AI
          assistants.
        </p>
      ...
      {slug && (
        <section>
          ...
          <p>
            {label} is an indexable VidoraHub Studio entity page for discovering
            creators and brands. It connects public profiles to categories,
            platforms, cities, states and search pages using crawlable internal
            links.
          </p>
        </section>
      )}
